...
export const webApplication: WEB_APP[] = [
  {
    name: "Bertanya",
    tools: ["Next JS", "Tailwind CSS", "Supabase", "jotai"],
  ...
  },
  {
    name: "OnDay",
    tools: [
      "React Js (Admin Template Minimal UI)",
      "Material UI",
      "Zustand",
      "React Query",
      "Nest JS",
    ...
    img: "",
    link: null,
    tag: "This is my startup application that I'm still developing today. This app is about warehouse, cashier, mini e-commerce management and more advance feature. If necessary, we can do a demo session about this application.",
  },
  // {
  //   name: "Money",
  //   tools: [
